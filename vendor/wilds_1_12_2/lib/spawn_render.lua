...
local function bakeSheet(species, sourcePath, log)
  -- The embedded release contains native six-frame sheets for every
  -- registered species. Mod sandboxes have no writable image-cache API, so
  -- a damaged/missing sheet falls back to its battle front without baking.
  return nil
end
