...
function CellOccupancy.isFollowerEntity(entity)
  ...
  -- Kanto Ascendant's native 1-4 chain keeps extras passable to the player
  -- and out of ow.npcs, but publishes this marker on every link. Wilds must
  -- still reserve around them or a chasing spawn can occupy the same cell.
  if entity._ascendantNativeFollower == true then return true end
