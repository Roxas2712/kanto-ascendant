...
WaterSpriteRegistry.RUNTIME_REL = "assets/bundled_runtime/water_runtime"
...
WaterSpriteRegistry.SILHOUETTE_RUNTIME = {
  swimming = "assets/bundled_runtime/swimming_silhouette_runtime",
  levitates = "assets/bundled_runtime/levitates_silhouette_runtime",
}
