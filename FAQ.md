...
Version 6.5.14 also closes the loss-specific blackout edge: when defeat sends
the player to a Pokémon Center, cleanup releases the encounter input lock from
