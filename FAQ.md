...
This is the public reference for **Kanto Ascendant 6.5.10**. It applies to Red,
...
1. Download the release `.zip` from the
   [6.5.10 GitHub release](https://github.com/Roxas2712/kanto-ascendant/releases/tag/v6.5.10).
...
No. Version 6.5.10 upgrades existing Red, Blue and Yellow saves in place.
