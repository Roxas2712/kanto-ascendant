# Riolu native walking friendship fix — 6.7.10
...
Desktop runtime test only; no physical mobile-device test. Import ZIP and restart fully to install. Rollback: reinstall 6.7.9.
