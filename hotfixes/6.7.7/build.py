...
VERSION='6.7.7'
EXPECTED='f3c8a57822b56f46607163bafba7d002b0a8b7906b3fbeec9bac70b522c809c7'
sha=lambda b:hashlib.sha256(b).hexdigest()
assert sha(BASE.read_bytes())==EXPECTED
names=['hoenn_acquisition_67_data.lua','hoenn_discovery.lua','hoenn_trace_presentation_67.lua','mega_evolution.lua','generation_move_catalog_67.lua']
