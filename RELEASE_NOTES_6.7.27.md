...
Complete update based on 6.7.26, published as a regular Latest release for launcher updates. Recommended pairing: VASC 3.0.51. Update both installed mods for combined log sending.
...
## Install
Close the game, update through the launcher or import Kanto-Ascendant-6.7.27.zip, then restart. Existing saves and optional/custom artwork are preserved. See SUPPORT_REPORTS.md and QA-REPORT.md for details.
