...
E.profiles = {
  {
    ...
    giftCode = true,
    spriteAuthority = "edition-native-species",
  ...
  },
  {
    id = "event_articuno",
    species = "ARTICUNO",
    name = text("WINTER SKY ARTICUNO", "WINTERHIMMEL-ARKTOS"),
    short = text("ARTICUNO", "ARKTOS"),
    source = text("Kanto Ascendant 6.6 event profile",
      "Kanto-Ascendant-6.6-Eventprofil"),
    level = 50,
    moves = { "PECK", "ICE_BEAM", "AGILITY", "MIST" },
    giftCode = true,
    giftCodeOnly = true,
    spriteAuthority = "edition-native-species",
    editions = { "red", "blue", "yellow" },
    badges = 0,
    terrain = "ice",
    habitat = "legendary_bird",
  },
  {
    id = "event_zapdos",
    species = "ZAPDOS",
    name = text("THUNDER PEAK ZAPDOS", "DONNERGIPFEL-ZAPDOS"),
    short = text("ZAPDOS", "ZAPDOS"),
    source = text("Kanto Ascendant 6.6 event profile",
      "Kanto-Ascendant-6.6-Eventprofil"),
    level = 50,
    moves = { "THUNDERSHOCK", "DRILL_PECK", "THUNDER", "AGILITY" },
    giftCode = true,
    giftCodeOnly = true,
    spriteAuthority = "edition-native-species",
    editions = { "red", "blue", "yellow" },
  ...
  },
  {
    id = "event_moltres",
    species = "MOLTRES",
    name = text("EMBER WING MOLTRES", "GLUTSCHWINGE-LAVADOS"),
    short = text("MOLTRES", "LAVADOS"),
    source = text("Kanto Ascendant 6.6 event profile",
      "Kanto-Ascendant-6.6-Eventprofil"),
    level = 50,
    moves = { "PECK", "FIRE_SPIN", "AGILITY", "SKY_ATTACK" },
    giftCode = true,
    giftCodeOnly = true,
    spriteAuthority = "edition-native-species",
    editions = { "red", "blue", "yellow" },
  ...
  },
  {
    id = "event_mewtwo",
    species = "MEWTWO",
    name = text("CERULEAN ARCHIVE MEWTWO", "AZURIA-ARCHIV-MEWTU"),
    short = text("MEWTWO", "MEWTU"),
    source = text("Kanto Ascendant 6.6 event profile",
      "Kanto-Ascendant-6.6-Eventprofil"),
    level = 70,
    moves = { "CONFUSION", "PSYCHIC_M", "BARRIER", "RECOVER" },
    giftCode = true,
    giftCodeOnly = true,
    spriteAuthority = "edition-native-species",
    editions = { "red", "blue", "yellow" },
