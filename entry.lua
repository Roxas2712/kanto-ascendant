...
-- execute only expanded PC storage, the shared Bank bridge and the modular Mega capability needed
...
return function(mod)
  ...
  mod.exports.expandedStorage = loadSibling(mod, "expanded_storage.lua")(mod, currentGeneration)
