# Rollback von 6.5.0 RC8 auf RC7

Das separate Paket
`kanto-ascendant-6.5.0-rc8-rollback-to-rc7.zip` enthält exakt den zuvor
getesteten RC7-Stand.

1. Spiel und Launcher vollständig beenden.
2. Den aktuellen Spielstand zusätzlich sichern.
3. Das RC8-Rollback-Paket im Mod-Manager importieren und den vorhandenen
   Kanto-Ascendant-Stand ersetzen.
4. Spiel und Mod-Manager neu starten.
5. Den Spielstand laden und die bisherige RC7-Konfiguration weiterverwenden.
